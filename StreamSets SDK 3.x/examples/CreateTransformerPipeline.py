"""
Example: Creating Transformer pipeline with Redshift destination
"""
import os
...
redshiftstage.set_attributes(
    bucket="S3_BUCKET",
    redshift_endpoint=os.getenv('REDSHIFT_ENDPOINT', 'your-redshift-endpoint'),
    schema='test',
    table='test',
    write_mode='INSERT',
    ...
    iam_role_for_copy_from_s3=os.getenv('IAM_ROLE_ARN', 'arn:aws:iam::account:role/role-name')
)
